...
class AppDemo(QWidget):
    def __init__(self):
        ...
        self.resize(250, 150)
        self.setStyleSheet("color: #05BDBD;background-color: black")

        layout = QVBoxLayout()
 
        fnt = QFont('blue', 25, QFont.Bold)
 
        self.lbl = QLabel("transparent ", self)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.height = 1060
        self.initUI()
        oImage = QImage("jarvis.jpg")
        sImage = oImage.scaled(QSize(1920,1060))                   # resize Image to widgets size
        palette = QPalette()
    ...
    def initUI(self):
        ...
        button.setStyleSheet("background-image : url(button1.png);")
        button.setGeometry(880, 470, 160, 140) 

        button.clicked.connect(self.one_click)
        button = QPushButton(' ', self)#Button
        
        button.setStyleSheet("background-image : url(button2.png);")
        button.setGeometry(0, 630, 420, 250)

        button.clicked.connect(self.two_click)
        button = QPushButton(' ', self)#Button
        
        button.setStyleSheet("background-image : url(button3.png);")
        button.setGeometry(1540, 740, 370, 220) 

        button.clicked.connect(self.three_click)
        self.show()
    def one_click(self):
        import os
