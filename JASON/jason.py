...
if a==1:
    ...
    command=0
    oral=1
    while command!="bye" and command!="goodbye" and command!="good bye":
        ...
        if cmp(command,search,'search')==True:
            ...
            say("clock opened")
            import os
            os.startfile("C:/Users/chenz/OneDrive/桌面/JASON/functions/clock.py")
            ...
            if x==1:
                say("Did you hear about the mathematician who's afraid of negative numbers?")
            elif x==2:
                say("Why do we tell actors to break a leg?... Because every play has a cast.")
            elif x==3:
                say('''
